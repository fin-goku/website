function calculateInflation() {
    ...
    document.getElementById('inflationResult').textContent = `Future value: Rs.${futureValue.toFixed(2)}`;
}
...
function calculateCompoundInterest() {
    ...
    document.getElementById('compoundResult').textContent = `Compound Interest: Rs.${compoundInterest.toFixed(2)}`;
}
